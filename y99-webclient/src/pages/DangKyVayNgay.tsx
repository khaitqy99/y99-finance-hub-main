          ...
          <div className="mt-4 grid lg:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <h1 className="mt-4 text-3xl md:text-4xl lg:text-5xl leading-tight font-extrabold">
                Đăng ký vay ngay
                <span className="block mt-2 text-accent">Nhận tư vấn vay tiền trong 5 phút</span>
              </h1>
              <p className="mt-4 text-white/90 max-w-xl">
                Điền thông tin nhanh để Y99 hỗ trợ <strong className="font-semibold text-white">khoản vay phù hợp</strong> theo nhu cầu
                và tài sản đảm bảo của bạn — thủ tục <strong className="font-semibold text-white">đăng ký vay</strong> đơn giản, bảo mật.
              </p>
