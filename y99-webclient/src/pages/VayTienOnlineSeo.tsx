  ...
  return (
    <div className="bg-background">
        ...
        <div className="container py-14 md:py-20 grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-start">
          <div>
            ...
            <h1 className="mt-4 text-3xl md:text-4xl lg:text-5xl leading-tight font-extrabold">
              Vay tiền online
              <span className="block text-accent mt-2">Cầm cố nhanh, gọn, chuyên nghiệp — lãi suất 1,099%/tháng</span>
            </h1>
            <p className="mt-4 text-white/90 max-w-2xl">
              <strong className="font-semibold text-white">Vay tiền online</strong> trả góp bằng đăng ký xe máy, ô tô hoặc iCloud
              với lãi suất theo dư nợ giảm dần. Y99 hỗ trợ <strong className="font-semibold text-white">vay cầm cố</strong> minh bạch,
              duyệt nhanh, hồ sơ đơn giản — phù hợp nhu cầu <strong className="font-semibold text-white">vay trả góp</strong> linh hoạt.
            </p>
          ...
          <form onSubmit={onSubmit} className="rounded-3xl bg-white text-foreground p-6 md:p-7 shadow-card">
            <h2 className="text-2xl font-extrabold">Đăng ký vay tiền online ngay</h2>
      ...
      <section className="py-14">
        <div className="container">
          <div className="rounded-3xl border border-border bg-card p-7 md:p-8">
            <h2 className="text-2xl md:text-3xl font-extrabold">Thông tin khoản vay và cầm cố</h2>
            <div className="mt-6 grid lg:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-bold">Hồ sơ vay cầm cố</h3>
              ...
              <div>
                <h3 className="text-lg font-bold">Điểm nổi bật khi vay online</h3>
                <div className="mt-3 space-y-3">
                  {highlights.map((item) => (
                    <div key={item} className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              ...
              <div>
                <h3 className="text-lg font-bold">Tài sản đảm bảo cầm cố</h3>
                <div className="mt-3 space-y-3">
                  {collateral.map((item) => (
                    <div key={item} className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-primary mt-0.5 shrink-0" />
              ...
              <div>
                <h3 className="text-lg font-bold">Điều kiện khoản vay</h3>
                <div className="mt-3 space-y-3">
                  {terms.map((item) => (
      ...
      <section className="pb-14">
        <div className="container">
          <div className="rounded-3xl border border-border bg-card p-7">
            <h2 className="text-2xl font-extrabold">Các gói vay cầm cố tại Y99</h2>
      ...
      <section className="py-14 bg-secondary/40 border-y border-border/60">
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-extrabold">Lãi suất và chi phí vay</h2>
      ...
      <section className="py-14">
        <div className="container">
          <div className="rounded-3xl bg-gradient-hero text-white p-8 md:p-10">
            <h2 className="text-2xl md:text-3xl font-extrabold">Phương thức trả nợ vay trả góp</h2>
            <div className="mt-4 grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-white/20 bg-white/10 p-4">
                <h3 className="font-bold">Phương án 1</h3>
                <p className="text-white/90 mt-2">Trả gốc, lãi và chi phí vay hàng tháng.</p>
              </div>
              <div className="rounded-2xl border border-white/20 bg-white/10 p-4">
                <h3 className="font-bold">Phương án 2</h3>
      ...
      <section className="pb-14">
        <div className="container">
          <div className="rounded-3xl border border-border bg-card p-7">
            <h2 className="text-2xl font-extrabold">Hình thức giải ngân khoản vay</h2>
      ...
      <section className="pb-14">
        <div className="container grid lg:grid-cols-2 gap-8">
          <div className="rounded-3xl border border-border bg-card p-7">
            <h2 className="text-2xl font-extrabold">Giới thiệu Y99 Finance</h2>
            <div className="mt-4 space-y-3 text-muted-foreground">
              <p>
                Y99, một tổ chức chuyên cung cấp <strong className="font-semibold text-foreground">dịch vụ tài chính cá nhân</strong> theo mô hình chuỗi, đã xây
                dựng mạng lưới phòng giao dịch tại nhiều tỉnh thành trên khắp Việt Nam. Dịch vụ{" "}
                <strong className="font-semibold text-foreground">vay cầm cố</strong> của Y99 được đánh giá cao về tính linh hoạt, sự minh bạch và đặc biệt phù hợp với nhóm
              ...
              <p>
                ...
                hỗ trợ cấp vốn nhanh chóng, điều kiện thủ tục đơn giản và minh bạch về{" "}
                <strong className="font-semibold text-foreground">lãi suất vay</strong>, chi phí dịch vụ.
              ...
              <p>
                ...
                và đưa ra phương án gia hạn nợ theo từng tình huống cụ thể của khách hàng — kể cả{" "}
                <strong className="font-semibold text-foreground">vay bằng cà vẹt xe</strong> hay iCloud.
              </p>
            </div>
          </div>

          <div className="rounded-3xl border border-border bg-card p-7">
            <h2 className="text-2xl font-extrabold">Ví dụ chi phí vay cầm cố xe máy</h2>
