  ...
  return (
    <>
      <PageHero
        ...
        title={article.seoH1 || article.title}
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          ...
          <img
            src={article.image}
            alt={resolveArticleImageAlt(imageIndex++, article.imageAlt, altCtx)}
            className="rounded-3xl w-full aspect-[16/9] object-cover shadow-card"
          />
            ...
            {related.map((a) => (
              <Link key={a.slug} href={`/ban-tin/${a.slug}`} className="group rounded-2xl bg-card overflow-hidden border border-border/60 shadow-soft hover:shadow-card transition-smooth">
                <div className="aspect-[16/10] overflow-hidden">
                  <img
                    src={a.image}
                    alt={resolveArticleImageAlt(0, a.imageAlt, {
                      title: a.title,
                      excerpt: a.excerpt,
                      category: a.category,
                    })}
